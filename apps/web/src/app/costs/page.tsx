/**
 * FILE PURPOSE: Costs page — displays cost observability data from API
 *
 * WHY: Users need visibility into LLM spend, per-agent costs, and error rates.
 * HOW: Server component fetches GET /api/costs and renders summary cards + agent table.
 */
